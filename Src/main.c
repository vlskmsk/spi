...
//		HAL_GPIO_WritePin(STAT_PORT,STAT_PIN, 0);
	...
	while(1)
	{
		/*TODO: consider adding 1 byte which is the checksum of the PREVIOUSLY sent command.
		 * Every time central sends a new command, we'll add that byte to the end of our tx packet.
		 * Then, central can verify the previously sent command went through ok
		 * */
		handle_comms();
...
//		{
//			TIMER_UPDATE_DUTY(500,500,500);
//			gl_theta_enc = unwrap( theta_rel_rad(), &foc_theta_prev);
//			break;
//		}
//		};
	}
